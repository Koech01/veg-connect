...
import type { ProfileProps, GroupProps, PlantRank } from '../types/index'; 
...
const MobilePlantPairAndList: React.FC<ProfileProps> = ({ profile }) => {
...
export default MobilePlantPairAndList; 